...
/* ==================================================================
 * AES-256 (Advanced Encryption Standard) - Blok Boyutu 16 Byte
 * ================================================================== */
...
// AES-256 Temel Fonksiyonları (Yazılım tabanlı fallback)
...
// AES-CBC Modu (Dosya sistemi için)
...
/* --- ÇAKIL / RISC-V DONANIM HIZLANDIRMASI (Gelecek İçin) --- */
